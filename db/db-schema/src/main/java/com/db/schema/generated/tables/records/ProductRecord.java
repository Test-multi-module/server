...
public class ProductRecord extends UpdatableRecordImpl<ProductRecord> implements Record6<Long, String, String, Integer, Integer, String> {
    ...
    @Override
    public ProductRecord values(Long value1, String value2, String value3, Integer value4, Integer value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProductRecord(Long id, String categories, String description, Integer price, Integer rating, String title) {
        super(Product.PRODUCT);
